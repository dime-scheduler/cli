    ...
    public class JobTests
    {
        ...
        public void Mapping_Job_TestProperties()
        {
            JobOptions options = new()
            {
                ...
                ContactAddress = "TEST",
                ContactAddressGeoLat = 51.055346M,
                ContactAddressGeoLong = 4.460098M,
                ContactEmail = "TEST",
                ContactName = "TEST",
                ContactNo = "TEST",
                ContactPhone = "TEST",
                ...
                CustomerAddressGeoLat = 51.055346M,
                CustomerAddressGeoLong = 4.460098M,
                CustomerEmail = "TEST",
                CustomerName = "TEST",
                CustomerNo = "TEST",
                CustomerPhone = "TEST",
                ...
                SiteAddress = "TEST",
                SiteAddressGeoLat = 51.055346M,
                SiteAddressGeoLong = 4.460098M,
                SiteCity = "TEST",
                SiteCountry = "TEST",
                SiteCounty = "TEST",
                SiteEmail = "TEST",
                SiteFromAddress = "TEST",
                SiteFromAddressGeoLat = 51.055346M,
                SiteFromAddressGeoLong = 4.460098M,
                SiteFromCity = "TEST",
